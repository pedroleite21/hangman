...
bin/hangman: prepare obj/main.o obj/hangman.o obj/word_select.o obj/conio.o
	gcc -std=c99 -Wall -O0 -g3 -o bin/hangman obj/main.o obj/hangman.o obj/word_select.o obj/conio.o

obj/main.o: src/main.c
	gcc -std=c99 -Wall -O0 -g3 -c src/main.c -o obj/main.o -Ithirdparty

obj/hangman.o: src/hangman.c
	gcc -std=c99 -Wall -O0 -g3 -c src/hangman.c -o obj/hangman.o -Ithirdparty
